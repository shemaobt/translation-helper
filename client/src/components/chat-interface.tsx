      ...
      <div className="flex-1 flex flex-col">
        <div className="flex-1 flex justify-center items-center">
          <div className="max-w-2xl text-center">
            ...
            <h2 className="text-xl font-semibold text-foreground mb-2">Welcome to AI Agent</h2>
            <p className="text-muted-foreground">Start a conversation and I'll help you with any questions you have.</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="border-t border-border p-4">
        ...
        <p className="text-xs text-muted-foreground mt-2 text-center">
          AI responses are generated using your configured OpenAI agent.
        </p>
      </div>
    </div>
  );
